...
<video ?controls="${this.recording !== null}" playsinline autoplay   src="${this.recording}"></video>
</div>`;
...
//        this.recording = window.URL.createObjectURL(new Blob([event.data], {type: 'video/webm'}));
//        document.getElementById('result-stream').src = this.recordings;
